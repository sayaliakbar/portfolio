    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        >
          ...
          <p className="text-lg font-medium opacity-90">Resume</p>
          <p className="text-2xl font-bold mt-1 mb-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-md transition-colors duration-200 cursor-pointer flex items-center justify-center"
                    >
                      <svg
